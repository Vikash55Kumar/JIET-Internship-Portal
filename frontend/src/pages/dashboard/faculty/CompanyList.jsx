...
function CompanyList() {
    ...
    const getActiveBadge = (isActive) => {
        return isActive
            ? <span className="px-2 py-1 rounded-full bg-green-100 text-green-700 text-xs font-bold w-max">ACTIVE</span>
            : <span className="px-2 py-1 rounded-full bg-red-100 text-red-700 text-xs font-bold w-max">INACTIVE</span>;
    };
                                    ...
                                    <table className="w-full text-left border-collapse">
                                        ...
                                        <thead className="bg-gray-50 sticky top-0 z-10 border-b border-gray-200 shadow-sm">
                                            <tr>
                                                ...
                                                <th className="py-2 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Active</th>
                                            ...
                                            {filteredCompanies.length > 0 ? (
                                                filteredCompanies.map((company) => {
                                                    ...
                                                    <tr key={company._id} className="hover:bg-red-50/30 transition-colors group">
                                                        ...
                                                        {/* Active */}
                                                        <td className="py-3 px-6 align-top">
                                                            {getActiveBadge(company.isActive)}
                                                        </td>
                                                        {/* Actions */}
